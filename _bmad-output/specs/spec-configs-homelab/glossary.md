...
- **Fleet** — The full set of nodes: caprica, kobol, picon (workstations/servers), pi4-0006/02/03/05 and pi5-0004 (Raspberry Pi), plus VMs. All current Pi nodes run Ubuntu; Raspberry Pi OS remains a deliberately supported target for a possible future Pi node needing a desktop environment.

...
The PRD's Glossary (§3) defines the Pi fleet (pi4-0006/02/03/05, pi5-0004) without any mention of OS, and nowhere states that Raspberry Pi OS remains a deliberately-supported future option despite no current node using it. A reader of the PRD alone, cross-referencing the README, would rediscover the apparent discrepancy with none of the resolution already reached in the PRFAQ — re-opening a question that was deliberately closed.

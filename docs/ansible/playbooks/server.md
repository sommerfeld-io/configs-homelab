...
This Ansible playbook performs comprehensive setup and configuration of server nodes in the home lab environment.

The playbook handles both system-level configuration requiring elevated privileges and user-specific customizations to create a standardized, secure, and productive environment.
